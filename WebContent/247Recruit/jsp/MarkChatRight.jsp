...
session.setAttribute( "Bpo_Cand_Id", canId );
	...
	try
	{
		...
		rs=cs.executeQuery();
Statement stmtScore, stmtTest;
ResultSet rsScore, rsTest;
session.setAttribute( "page", "ChatTestUpdateRight_Re.jsp" );
...
<html>
  ...
  <body>
  <form name="BioForm" ENCTYPE="multipart/form-data" action="<%=recruitPath%>jsp/MarkChatSubmit.jsp" method="post">
	...
	int ApplyingFor=0;
  	if(rs.next())
  	{
    	...
    	String queryScore="select * from candidate_chat_score where Cand_Id=" + autoId + ""; 
    	System.out.println("queryScore:::::::"+queryScore);
    	stmtScore=connection.createStatement();
		rsScore=stmtScore.executeQuery(queryScore);
		
		String queryTest="select * from mock_chat_test_attempt_master where User_Id=" + autoId + ""; 
       ...
       <tr>
        ...
        <tr>
         ...
         <tr>
            ...
            <td align="left" class="allBackColor">
                ...
                if(rsTest.next())
                {
            		if(rsTest.getDate("End_Date_Test")==null)
            		{
            	 %>
            	 	NA
            	<%}
            		...
            		{
	            		Date dateVoiceTestUploadOn = rsTest.getDate("End_Date_Test");
         ...
         <tr>
            ...
            <td align="left" class="allBackColor">
                <%
                	if(rsScore.next())
				  	{
				  	if(rsScore.getDate("Last_Scored_Date")==null)
            		{
            	   %>
            	 	NA
            	   <%}			  		
				  		Date dateScore = rsScore.getDate("Last_Scored_Date");
				  		SimpleDateFormat formatter2 = new SimpleDateFormat("dd-MMM-yyyy");
				    	lastScoreOn = formatter2.format(dateScore);
				    	lastScoreBy=rsScore.getString("Recruiter_Id");
				    	lastScore=rsScore.getString("Total_score");
                	}
                 %>
                 <%=lastScoreOn%>
                 <%
				...
				String seccsrec = "select Emp_Name from user_master where Emp_ID='"+lastScoreBy+"'";
				System.out.println("Query::::::"+seccsrec);
				Statement stsrec = connection.createStatement();
        ...
        <tr>
            <td colspan="3" align="center">   
                ...
                <input type="submit" name="submit" value="Rescore Chat" class="buttonMedium" />&nbsp;&nbsp;
