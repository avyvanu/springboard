...
String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details where cand_Status=4 and Applying_For=1 and IsFirstRoundUpload!=1 and Location='"+User_Center_Id+"'"; 
System.out.println("query::First Audio Upload::"+query);
...
<html>
  <head>
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/FirstAudioRight.jsp?candId="+canId;
  	}
