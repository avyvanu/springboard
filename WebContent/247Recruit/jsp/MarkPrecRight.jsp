...
session.setAttribute( "page", "PrecisTestUpdateRight_Re.jsp" );	
...
<html>
  ...
  <body>
  <form name="BioForm" ENCTYPE="multipart/form-data" action="<%=recruitPath%>jsp/MarkPrecSubmit.jsp" method="post">
	...
	int ApplyingFor=0;
  	if(rs.next())
  	{
    	...
    	String queryScore="select * from candidate_precis_writing_score where Cand_Id=" + autoId + ""; 
    	stmtScore=connection.createStatement();
		rsScore=stmtScore.executeQuery(queryScore);
		
		String queryTest="select * from precis_test_attempt_master where USER_ID=" + autoId + ""; 
       ...
       <tr>
        ...
        <tr>
            <td colspan="3" align="center">   
                ...
                <input type="submit" name="submit" value="Rescore Précis" class="buttonMedium" />&nbsp;&nbsp;
