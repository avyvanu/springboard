    ...
    <table cellpadding="0" cellspacing="0" width="100%">
	    ...
	    <tr>
	        ...
	        <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial;">
	            ...
	            <font class="nonLink">Validate Candidate Offer</font>
	        </td>
	            ...
	            <table width="970px" border="0" cellpadding="0" cellspacing="0">
		            <tr>
						<td style="width:420px;">
							  <iframe src="<%=recruitPath%>jsp/CandidatelHROpsLeft.jsp" name="left" width="420px" height="700" scrolling="auto" frameborder="0" ></iframe>
						</td>
						<td style="width:570px;">
							<iframe src="<%=recruitPath%>jsp/CandidatelHROpsRight.jsp" name="right" width="570px" height="700" scrolling="auto" frameborder="0" ></iframe>
						</td>
					</tr>
	            </table>
	        </td>
