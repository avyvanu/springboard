...
<%
    ...
    System.out.println("USER_Name in LD Language righthome page::::"+USER_Name);
	...
	try
	{
		...
		String langScorePath=recruitPath+"jsp/LanguageTestScore.jsp?candidateid="+canId;
%>
<html>
  <head>
    <base href="<%=basePath%>">
    ...
    {
		parent.location.href= "<%=langScorePath%>";
	}
	function showWindow()
	{
  ...
  <form name="BioForm" onsubmit="return RedirectPage();">
	...
	int MarkLangReScore=0;
  	if(rs.next())
  	{
		...
		MarkLangReScore = rs.getInt("MarkLangReScore");
		System.out.println("MarkLangReScore"+MarkLangReScore);
		if(MarkLangReScore==1)
		{
			session.setAttribute( "LangPageVal", "2" );
		}
		else
		{
			session.setAttribute( "LangPageVal", "1" );
		}
       ...
       <tr>
        ...
        <tr>
            <td colspan="3" align="center">   
                ...
                <input type="submit" name="submit" value="Score Language" class="buttonMedium" />&nbsp;&nbsp;
