...
String ProofStatus=(String)session.getAttribute("ProofStatus6");
System.out.println("UploadEmployement2 Page::::ProofStatus::::"+ProofStatus);
if(ProofStatus==null)
{
session.setAttribute( "ProofStatus6", "0");
ProofStatus = "0";
}
session.setAttribute( "proofName", "EmploymentProof2" );
...
String redURL=recruitPath + "jsp/UploadEmployment2.jsp?proofName="+proof;
session.setAttribute("redURL6",redURL);
...
System.out.println("Upload Employment2 page:: otherDetails"+otherDetails); 
session.setAttribute("OtherDetails6",otherDetails);
}
String FileName=(String)session.getAttribute("FileName6");
if(FileName==null)
{
FileName="";
}
System.out.println("Upload Employement2 page::FileName::"+FileName);
%>
...
<html>
  ...
  <body style="background-color: #F8F8F8;">
    <form name="FileUpoadForm" ENCTYPE="multipart/form-data" action="<%=recruitPath%>jsp/DocumentUpload.jsp?proofName=EmploymentProof2&proofType=6" method="post" onsubmit="return check(this);" >
    	<table cellpadding="0" cellspacing="0" border="0">
    		<tr>
    		<%
    		System.out.println("Upload Employment2 page::::Session Value of:::::"+ProofStatus);
    		if(ProofStatus.equalsIgnoreCase("1")){ 
    		%>
    		<script type="text/javascript" language="JavaScript">
    		var Employment2proofHiddenFld=parent.document.getElementById('Employment2proofHiddenFld');
        	Employment2proofHiddenFld.value = "1";
    		</script>
    		  <td>
    		  <input id="FilePathDISP" value="File : <%= FileName%>, successfully uploaded." size="50" readonly="readonly" style="border: none;background-color: #F8F8F8;"> 
	            ...
	            <td align="center" style="width:75px;">
			      <input type="submit" name="reset" value="Change" class="inputFileButtons" id="reset" onclick="HideProcess();"/>
	           </td>
    		<%} else { %>
    		<script type="text/javascript" language="JavaScript">
    		var Employment2proofHiddenFld=parent.document.getElementById('Employment2proofHiddenFld');
        	Employment2proofHiddenFld.value = "0";
    		</script>
            <td id="tdfile">
