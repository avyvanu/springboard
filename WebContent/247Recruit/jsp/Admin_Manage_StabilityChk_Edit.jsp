...
%>
		<html>
			<head>
				...
				<script language="javascript" type="text/javascript" src="<%=request.getContextPath()%>/247Recruit/js/addStabilityChkRow.js"></script>	
				...
				<script type="text/javascript">
				function removeSplChar(part,QnsId)
				{
					var objTemp;
					objTemp = document.getElementById( 'part'+ part+ 'addQues'+QnsId).value;
					objTemp = objTemp.replace(/…/gi,"...");
					document.getElementById('part'+ part+ 'addQues'+QnsId).value = objTemp;
				}
				</script>
					...
					for(t =1;t<=t_box;t++) 
					{
						...
						total_box_Qns = document.getElementById('total_box_Qns'+t).value;
						 for (s=1; s<=parseInt(total_box_Qns); s++)
						 {
							...
							var addQuestion = addQues.replace("…","...");
							document.getElementById('part' + t + 'qns' + s).innerHTML = addQuestion;
						 }
						 
					} 
						document.getElementById('stabilityAddQues').style.display = 'none';
				...
				{
					if(confirm('Are you sure you want to submit the updated Stability Check Questionnaire? It will be available to interviewers immediately.'))
					{
				...
				function cancel()
				{
					...
					{
						top.location.href = "<%=recruitPath%>jsp/Admin_Manage_StabilityChk.jsp";
					}
					else
					{
						return false;	
				...
				function cancelButton()
				{
					...
					document.getElementById('stabilityAddQues').style.display="";
				}
				</script>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						<td align="left" style="padding-left: 10px;">
							...
							<font style="color: #7E7E7E; font-weight: bold; font-size: 12px; font-family: Arial;">
								<a href="<%=recruitPath%>jsp/Admin_Manage_StabilityChk.jsp">
								Manage Stability Check Questionnaire
								</a> 
								>
							</font>
					...
					<tr>
						<td colspan="2" align="center" valign="top">
 							<form action = "<%=request.getContextPath()%>/AddStabilityCheck" method="post" autocomplete="off">
							 	<div id="stabilityAddQues">
									<br />
									<table width="900" border="0" cellpadding="0" cellspacing="0">
										<tr>
							        		<th class="classheader_TD" style="padding: 6px;" colspan="4">
							        			Edit Stability Check Questionnaire
							        		</th>
							        	</tr>
						  	        	<tr>
						 					<td colspan="2">
						  	        	...
						  	        	<tr>
						 					<td colspan="2">
												...
												int qnsCount = 0;
											        String Querytype = "select count(*) as count from Stability_part_master where IsAlive=1";
													...
													while(rsspartid.next())
													{
														...
														String secqnsCount = "select count(Question_Id) as Count from stability_check_question_master where Part_Id = '"+partid+"' and IsAlive = 1";
														...
														while(rssqns.next())
														{
													        ...
													        System.out.println("stability_check_question_master table details "+secpart);
															...
															while(rsspart.next())
															{
																...
																String Questionval = rsspart.getString("Question");
																System.out.println("Questionval-"+j+" ::: " + Questionval);
																Question = Questionval.replace("…", "...");
																System.out.println("Question-"+j+" ::: " + Question);
																qorderno = rsspart.getString("order_no");
															
															%>
															    <input type = "hidden" id = "total_parts_st" name = "total_parts_st" value = " <%=partCount%>">
																...
																<input type = "hidden" id = "part<%=i%>Ques<%=j%>" name = "part<%=i%>Ques<%=j%>" value = '<%=Question.trim()%>'>
															<%
							        ...
							        <table width="900px">
										<tr >
											<td align="left" >
												<input type="button" name="Cancel"  value="Cancel" class="buttonMedium" onclick="return cancel();"/>
											</td>
											<td align = "center">
												<input type="button" name="AddPart"  value="Add Part" class="buttonMedium" onclick="addRowHeaderStability(); addQuestionOnAddPartStability(); addRowButtonsOnAddPartStability();"/>
											</td>
											<td align = "right">
								...
								<div id="previewpage" style="display: none;">
									<table width="900px" cellspacing="6" cellpadding="6" border="0">
										...
										<tr>
							        		<th class="classheader_TD" style="padding: 6px;" colspan="4">
							        			Preview : Edited Stability Check Questionnaire
							        		</th>
							        	</tr>
										<tr>
											<td width="120" rowspan="3" style="padding: 0px;"> 
											...
											<td width="200" class="allBackmain" align="left" ><b>Highest Education</b></td>
											<td width="180" class="allBackColor" align="left">
												&lt;<%= higeduc %>&gt;
											</td>
										</tr>
										<tr align="left">
									...
									<table id="tblSample1" width="900" border="0" cellpadding="0" cellspacing="0">
										
									</table>
									<table width="900" cellspacing="6" cellpadding="6" border="0">  
										<tr>
