...
String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details where cand_Status=5 and Applying_For=1 and IsVAAudioUpload!=1 and Location='"+User_Center_Id+"'"; 
...
<html>
  <head>
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/VAAudioRight.jsp?candId="+canId;
  	}
