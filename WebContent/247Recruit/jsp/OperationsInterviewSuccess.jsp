...
System.out.println("USER_Name in Ops  success page::::"+USER_Name);
 ...
 background: url("<%=request.getContextPath() %>/247Recruit/images/header_BG.jpg") repeat-x scroll 0 0 transparent;color: #FFFFFF;
  ...
  <body>
   ...
   <form>
	...
	You have successfully Scored for Operations.
	</b><br/>
	<ul>
	
<li> <a href="<%=recruitPath%>jsp/Chat_Init.jsp?progVal=<%=progVal%>" style="color: gray"><b>Score another Candidate</b></a><br/></li>
