	    ...
	    <tr>
	        <td align="left" style="padding-left:10px;">
	         <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial; ">
	            ...
	            <font class="nonLink">Rescore Chat Test</font>
	        </td>
	            ...
	            <table width="900px" border="0" cellpadding="0" cellspacing="0">
		            <tr>
						<td style="width:450px;">
							  <iframe src="<%=recruitPath%>jsp/MarkChatLeft.jsp" name="left" width="450px" height="600px" scrolling="auto" frameborder="0" ></iframe>
							  
						</td>
						<td style="width:450px;">
							<iframe src="<%=recruitPath%>jsp/MarkChatRight.jsp" name="right" width="450px" height="600px" scrolling="auto" frameborder="0" ></iframe>
						</td>
					</tr>
	            </table>
	        </td>
