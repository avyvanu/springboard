...
<%
	...
	try
	{
		 ...
		 System.out.println("EmployeeID in VOICE home page::::"+USER_ID);
	     USER_AUTOID = (Integer)session.getAttribute("USER_AUTOID");
	     System.out.println("USER_AUTOID in VOICE home page::::"+USER_AUTOID);
	     User_Type_Id = (String)session.getAttribute("User_Type_Id");
	     System.out.println("User_Type_Id in VOICE home page::::"+User_Type_Id);
    	 USER_Name = ((String)session.getAttribute("USER_Name")).trim();
	     if(USER_Name==null)
		  	{
		  	  response.sendRedirect(request.getContextPath() + "/247Recruit/jsp/SessionTimeout.jsp");
		  	}
	     System.out.println("USER_Name in VOICE home page::::"+USER_Name);
	}
	catch(Exception e)
	{
		response.sendRedirect(request.getContextPath() + "/247Recruit/jsp/SessionTimeout.jsp");
	    ...
	    <tr>
	        <td align="left" style="padding-left:10px;">
	            <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial; "><a href="<%=recruitPath%>jsp/Home_Page.jsp">Home</a> > </font>
	             <font style="color:#000000; font-weight:bold; font-size:12px; font-family:Arial; ">Voice</font> 
	        </td>
		     ...
		     while(rsN.next())
		      {
		    	...
		    	System.out.println("task_id in VOICE home page::::"+task_id);
		    	taskDescription = rsN.getString("tm.task_description");
		    	System.out.println("taskDescription in VOICE home page::::"+taskDescription);
		    	task_URL =  rsN.getString("tm.task_url");
		    	System.out.println("task_URL in VOICE home page::::"+task_URL);
		%>
	        <tr>
		        <td>
		          <div align="center">
