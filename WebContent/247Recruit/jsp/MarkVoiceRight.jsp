...
<%
	...
	Statement stmtScore;
	ResultSet rsScore;
	session.setAttribute( "page", "Recruiter_Voice_Options.jsp" );	
...
<html>
  ...
  <body>
  <form name="BioForm" ENCTYPE="multipart/form-data" action="<%=recruitPath%>jsp/MarkVoiceSubmit.jsp" method="post">
       ...
       <tr>
        ...
        <tr>
            <td colspan="3" align="center">   
                ...
                <input type="submit" name="submit" value="Rescore Voice" class="buttonMedium" />&nbsp;&nbsp;
