...
<%
	...
	System.out.println("USER_ID in Docs Update left::::"+USER_ID);
	...
	System.out.println("User_Center_Id::::::additional docs left page"+User_Center_Id);
	String query="select * from bpo_candidatesreg_details where cand_Status > 5 and cand_Status < 8 and Init_Result = 1 and Upload_Done = 1 and Location = '"+User_Center_Id+"'"; 
  ...
  <head>
	...
	function CheckValidation()
			{
				...
				if(document.getElementById("VoiceScoreFrom").value >document.getElementById("VoiceScoreTo").value )
				{
	...
	<script type="text/javascript" language="javascript">
      function ChangeColor(tableRow, canId)
      {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/AdditionalDocsUpdateRight.jsp?candId="+canId;
  	  }
    </script>
  </head>
