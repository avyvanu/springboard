		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				<td align="left" style="padding-left:10px;">
					...
					<font class="nonLink">Manage Tests</font>
					...
					<table width="900" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td style="width:400px;">
								<iframe src="<%=recruitPath%>jsp/Admin_Manage_TestLeft.jsp" name="left" width="400" height="400" scrolling="auto" frameborder="0" ></iframe>
							</td>
							<td style="width:450px;">
								<iframe src="<%=recruitPath%>jsp/Admin_Manage_TestRight.jsp" name="right" width="450" height="400" scrolling="auto" frameborder="0" ></iframe>
							</td>
						</tr>
					</table>
				<br/>
