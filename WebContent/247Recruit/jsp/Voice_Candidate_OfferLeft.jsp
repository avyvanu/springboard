...
<%
	...
	System.out.println("User_Center_Id::::::offer voice"+User_Center_Id);
	String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details where cand_Status=8 and Applying_For=1 and Location='"+User_Center_Id+"'"; 
...
<html>
  <head>
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/Voice_Candidate_OfferRight.jsp?candId="+canId;
  	}
