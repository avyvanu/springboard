...
System.out.println("User_Center_Id::::::Left page ops"+User_Center_Id);
Connection connection=ConnectDatabase.getConnection();	
String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details where Bpo_Cand_Id NOT IN (select CandidateID from validate_candidate_offer_master where CandidateID is not null) and cand_Status=9  and Location='"+User_Center_Id+"'"; 
...
String FromDAte=request.getParameter("VoiceScoreFrom");
	...
	query = query+ " and Offered_On between '" + strFrom + " 00:00:00.000' and '" + strTo + " 23:59:59.999'";
...
<html>
  <head>
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/CandidatelHROpsRight.jsp?candId="+canId;
  	}
  ...
  <body>
   <table width="400" cellpadding="0" cellspacing="0">
       <tr>
	      <td colspan="2">
			          <form action="" method="post" onsubmit="return CheckValidation();" accept-charset="utf-8">
			             <table>
			            	 <tr>
		            			<td nowrap="nowrap">From:<input type="text" size="12" name="VoiceScoreFrom" id="VoiceScoreFrom" value=""/></td>
		            			<td nowrap="nowrap"> To:<input type="text" size="12" name="VoiceScoreTo" id="VoiceScoreTo" value=""/> </td>
    ...
    <table width="400" rules="all" style="border:1px solid black;background-color:#F2F2F2;margin:0;font-family: Arial,Helvetica,sans-serif; font-size: 13px;">
					<tr>
