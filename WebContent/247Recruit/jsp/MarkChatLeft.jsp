...
System.out.println("User_Center_Id::::::mark for chat"+User_Center_Id);
String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details a left join candidate_chat_score b on a.autoid=b.cand_id  where a.MarkChatReScore = 0 and (b.cand_id is not null and (a.cand_Status=4 or (a.cand_Status = 6 and a.Init_Result not in (1,3)))) and a.Applying_For=2 and a.Location='"+User_Center_Id+"'"; 
System.out.println("Mark for chat Rescore Query:::::"+query);
  ...
  <head>
   ...
   <title>[24]7 SPRINGBOARD</title>
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/MarkChatRight.jsp?candId="+canId;
  	}
