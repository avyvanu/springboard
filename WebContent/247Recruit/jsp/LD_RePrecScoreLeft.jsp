...
String LDEmployeeId=(String)session.getAttribute("USER_ID");
System.out.println("LDEmployeeId"+LDEmployeeId);
Connection connection=ConnectDatabase.getConnection();	
String CenterQuery="SELECT  Centre_Id FROM  user_master where Emp_ID='"+LDEmployeeId+"'";
...
String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name,System_Date_Time from bpo_candidatesreg_details where MarkPrecReScore=1 and cand_Status=6 and Applying_For=2 and Location='"+LDCentreId+"'"; 
...
function CheckValidation()
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/LD_RePrecScoreRight.jsp?candId="+canId;
  	}
