...
<%
	...
	System.out.println("USER_Name in LD Audio home page::::"+USER_Name);
  	String User_Type_Id = (String)session.getAttribute("User_Type_Id");
  	 if(User_Type_Id == null)
		  	{
		  	  response.sendRedirect(request.getContextPath() + "/247Recruit/jsp/SessionTimeout.jsp");
		  	}
	System.out.println("User_Type_Id in LD Voice home page::::"+User_Type_Id);
   %>
<html>
  <head>
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
	   <tr>
	    ...
	    <tr>
	      ...
	      <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial; "><a href="<%=recruitPath%>jsp/Home_Page.jsp">Home > </a> <a href="<%=recruitPath%>jsp/Voice_Home.jsp">Voice > </a>
	    ...
	    <tr>
	       <td colspan="2" align="center" valign="top">
	        <br/>
	            <table width="900px">
		            <tr>
						<td style="width:450px;" border="0" cellpadding="0" cellspacing="0">
							  <iframe src="<%=recruitPath%>jsp/LD_VoiceScoreLeft.jsp" name="left" width="450px" height="450px" scrolling="auto" frameborder="0" ></iframe>
							  
						</td>
						<td style="width:450px;">
							<iframe src="<%=recruitPath%>jsp/LD_VoiceScoreRight.jsp" name="right" width="450px" height="450px" scrolling="auto" frameborder="0" ></iframe>
						</td>
					</tr>
	            </table>
	        </td>
