...
System.out.println("User_Center_Id::::::Left Rep search left"+User_Center_Id);
String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details where  Location='"+User_Center_Id+"'"; 
System.out.println("query:::Repcandidatesearch:::::"+query);
...
<html>
  <head>
   ...
   <title>[24]7 SPRINGBOARD</title>
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/RepSearchRight.jsp?candId="+canId;
	    parent.bottom.location.href= "<%=recruitPath%>jsp/RepSearchBottom.jsp?candId="+canId;
  	}
  ...
  <table width="420">
    ...
    <table width="420" rules="all" style="border:1px solid black;background-color:#F2F2F2;margin:0;font-family: Arial,Helvetica,sans-serif; font-size: 13px;">
					<tr>
						<td style="border-bottom:1px solid black;margin:0;" align="center" nowrap="nowrap"><b>Candidate ID</b></td>
