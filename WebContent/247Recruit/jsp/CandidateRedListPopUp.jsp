					...
					<tr>
						<td align="center">
							 ...
							 <%
								...
								query="SELECT * FROM bpo_candidatesreg_details WHERE First_Name='"+FirstName+"' AND Last_Sir_Name='"+LastName+"' AND  Phone='"+PhoneNumber+"' AND Email='"+Email+"' AND Bpo_Cand_Id NOT IN ('"+CandidateId+"')"; 
								System.out.println("query:::::"+query);
							 	queryCount="SELECT count(*) as Count FROM bpo_candidatesreg_details WHERE First_Name='"+FirstName+"' AND Last_Sir_Name='"+LastName+"' AND  Phone='"+PhoneNumber+"' AND Email='"+Email+"' AND Bpo_Cand_Id NOT IN ('"+CandidateId+"')";
					 	...
					 	if(rs2.next())
						{
							CandidateCount=rs2.getInt("Count");
							  %>
						 Match found: <font color="#FF0000"><b><%=CandidateCount%></b></font>     	
						</td>
					</tr>
					  <%
						}
						            ...
						            <td align="left">               	
								        ...
								        <tr>
								           <%
								            		...
								            		{
								            	 %>
									            	 <td style="width:100px; padding-left:3px;" align="center">
										            	<img src="<%=recruitPath%>images/default_person.jpg" width="100px" height="100px" alt="image" />
										            </td>
								            	<%}
								            		else
								            		{
								            	%>
								            		 <td style="width:100px; padding-left:3px;" align="center">
										            	<img src="<%=candImgPath%><%=rs.getString("ImagePath")%>" width="100px" height="100px" alt="image" />
										            </td>
								            	<%}%>    
