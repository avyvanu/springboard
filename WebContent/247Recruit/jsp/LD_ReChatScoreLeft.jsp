...
String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name,System_Date_Time from bpo_candidatesreg_details where MarkChatReScore=1 and cand_Status=6 and Applying_For=2 and Location='"+LDCentreId+"'"; 
...
function CheckValidation()
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/LD_ReChatScoreRight.jsp?candId="+canId;
  	}
