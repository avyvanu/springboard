...
System.out.println("USER_ID in Res Upload left page::::"+USER_ID);
...
String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details where cand_Status < 6 and IsResumeUpload = 0 and Location='"+User_Center_Id+"'"; 
...
<html>
  <head>
   ...
   <title>[24]7 SPRINGBOARD</title>
    ...
    function ChangeColor(tableRow, candId)
    {
		...
		parent.right.location.href= "<%=recruitPath%>jsp/ResUpdateRight.jsp?candId="+candId;
  	}
