  ...
  <body>
  	 ...
  	 <table cellpadding="0" cellspacing="0" width="100%">
	    ...
	    <tr>
	        ...
	        <font style="color:#000000; font-weight:bold; font-size:12px; font-family:Arial; ">Rescore Chat Success</font>
	        </td>
		...
		<tr>
			<td height="100" style="background-color:#F7F7F7 ;font-family: Arial,Helvetica,sans-serif;font-size: 12px; color: #41383C;pa">
				<b style="padding-left: 5px">
					You have successfully Scored for Chat.
				</b>
				<br/>
				<ul>	
					<li> <a href="<%=recruitPath%>jsp/LD_ChatScore.jsp" style="color: gray"><b>Score another Candidate</b></a><br/></li>
