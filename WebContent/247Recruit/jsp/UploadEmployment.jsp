...
String ProofStatus=(String)session.getAttribute("ProofStatus5");
System.out.println("UploadEmployement Page::::ProofStatus:::"+ProofStatus);
if(ProofStatus==null)
{
session.setAttribute( "ProofStatus5", "0");
ProofStatus = "0";
}
session.setAttribute( "proofName", "EmploymentProof" );
...
String redURL=recruitPath + "jsp/UploadEmployment.jsp?proofName="+proof;
session.setAttribute("redURL5",redURL);
...
System.out.println("Upload Employment page::::otherDetails"+otherDetails); 
session.setAttribute("OtherDetails5",otherDetails);
}
String FileName=(String)session.getAttribute("FileName5");
if(FileName==null)
{
FileName="";
}
System.out.println("Upload Employement page::::FileName::"+FileName);
%>
...
<html>
  ...
  <body style="background-color: #F8F8F8;">
    <form name="FileUpoadForm" ENCTYPE="multipart/form-data" action="<%=recruitPath%>jsp/DocumentUpload.jsp?proofName=EmploymentProof&proofType=5" method="post" onsubmit="return check(this);" >
    	<table cellpadding="0" cellspacing="0" border="0">
    		<tr>
    		<%
    		System.out.println("Upload Employment page::::Session Value of:::::"+ProofStatus);
    		if(ProofStatus.equalsIgnoreCase("1")){ 
    		%>
    		<script type="text/javascript" language="JavaScript">
    		var EmploymentproofHiddenFld=parent.document.getElementById('EmploymentproofHiddenFld');
        	EmploymentproofHiddenFld.value = "1";
    		</script>
    		  <td>
    		...
    		<script type="text/javascript" language="JavaScript">
    		var EmploymentproofHiddenFld=parent.document.getElementById('EmploymentproofHiddenFld');
        	EmploymentproofHiddenFld.value = "0";
    		</script>
            <td id="tdfile">
