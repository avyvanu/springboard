...
System.out.println("User_Center_Id::::::Left va Audio"+User_Center_Id);
String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details where cand_Status=6 and Applying_For=1 and init_result in(0,2) and Location='"+User_Center_Id+"'"; 
...
<html>
  <head>
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/Voice_Candidate_SelectionRight.jsp?candId="+canId;
  	}
