...
String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details where BioSubmitStatus=0 and cand_Status > 5  and Location='"+User_Center_Id+"'"; 
  ...
  <head>
   <title>[24]7 SPRINGBOARD</title>
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/BioRegRight.jsp?candId="+canId;
  	}
