...
System.out.println("USER_Name in Res upload right page page::::"+USER_Name);
String candId = (String) request.getParameter("candId");
session.setAttribute( "Bpo_Cand_Id", candId );
	...
	int ApplyingFor=0;
  	if(rs.next())
  	{
       ...
       <tr>
        ...
        <tr>
            <td colspan="3">
                <iframe src="<%=recruitPath%>jsp/RecFileUploadUI.jsp" name="upload" width="500" height="70" scrolling="no" frameborder="0" ></iframe>
            </td>
        </tr>
     </table>
  		<%
