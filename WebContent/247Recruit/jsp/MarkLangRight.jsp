...
<html>
  <head>
    ...
    <title>[24]7 Mark Language for Re-Scoring</title>
  ...
  <body>
  <form name="BioForm" ENCTYPE="multipart/form-data" action="<%=recruitPath%>jsp/MarkLangSubmit.jsp" method="post">
	...
	int ApplyingFor=0;
  	if(rs.next())
  	{
    	...
    	String queryScore="select * from candidate_language_testscore where Cand_Id=" + autoId + ""; 
    	stmtScore=connection.createStatement();
		rsScore=stmtScore.executeQuery(queryScore);
		
		String queryTest="select * from language_test_attempt_master where Cand_Id=" + autoId + ""; 
       ...
       <tr>
        ...
        <tr>
         ...
         <tr>
            ...
            <td align="left" class="allBackColor">
                ...
                if(rsTest.next())
                {
            		if(rsTest.getDate("End_Date")==null)
            		{
            	 %>
            	 	NA
            	<%}
            		...
            		{
	            		Date dateVoiceTestUploadOn = rsTest.getDate("End_Date");
        ...
        <tr>
            <td colspan="3" align="center">   
                ...
                <input type="submit" name="submit" value="Rescore Language" class="buttonLarge" />&nbsp;&nbsp;
