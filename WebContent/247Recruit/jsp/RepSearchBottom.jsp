...
<%
   ...
   System.out.println("USER_Name in Rep search home page::::"+USER_Name);
 		...
 		<form name="BioForm" method="post" >
					...
					%>
				  	<table cellpadding="6" cellspacing="6" border="0" width="100%">
							<%		 
							 	String query3="select * from bpo_candidatesreg_details where Bpo_Cand_Id='" + canId + "'";
								...
								try
								{
									...
									String strProcedure="{call BpoCandSearch_Encrypt_Proc(?,?,?,?)}"; //your procedure name
									...
									rs=cs.executeQuery();
								 	queryCount = "select count(*) ResCount from bpo_candidatesreg_details where Bpo_Cand_Id not in ('"+canId+"')";
								 	queryCount = queryCount + "and First_Name like '%" + fname + "%'";
									...
									if(rs!=null)
									{
										if(rs2.next())
										{
											resCount=rs2.getInt("ResCount");
											System.out.println("resCount"+resCount);
									%>
						<tr>
				           <td align="left" colspan="2" style="background-color: #d8d8d8;" class="allBackColor">           	
				        ...
				        <tr>
	                        <td class="allBackColor" colspan="2" style="background-color: #d8d8d8; height: 5px; padding-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px;">
	                           &nbsp;
	                        </td>
	                    </tr>
							<%
