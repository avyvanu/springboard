...
String ProofStatus=(String)session.getAttribute("ProofStatus1");
if(ProofStatus==null)
{
session.setAttribute( "ProofStatus1", "0");
ProofStatus = "0";
}
System.out.println("UploadId Page::::ProofStatus::::"+ProofStatus);
session.setAttribute( "proofName", "IDProof" );
...
System.out.println("UploadID page:::proof Name::"+proof);
session.setAttribute("proof",proof);

String redURL=recruitPath + "jsp/UploadID.jsp?proofName="+proof;
session.setAttribute("redURL1",redURL);
...
System.out.println("UploadID page:::otherDetails"+otherDetails); 
session.setAttribute("OtherDetails1",otherDetails);
}
...
System.out.println("UploadId page::::FileName::::"+FileName);
%>
...
<html>
  ...
  <body style="background-color: #F8F8F8;">
    <form name="FileUpoadForm" ENCTYPE="multipart/form-data" action="<%=recruitPath%>jsp/DocumentUpload.jsp?proofName=IDProof&proofType=1" method="post" onsubmit="return check(this);" >
    	<table cellpadding="0" cellspacing="0" border="0">
    		<tr>
    		<%
	    		System.out.println("UploadUI Page::::Session Value:::::"+ProofStatus);
	    		if(ProofStatus.equalsIgnoreCase("1")){
    		%>
    		<script type="text/javascript" language="JavaScript">
    		var IDproofHiddenFld=parent.document.getElementById('IDproofHiddenFld');
        	IDproofHiddenFld.value = "1";
    		</script>
    		  <td>
