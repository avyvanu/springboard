  ...
  <form name="BioForm" onsubmit="return RedirectPage();">
	...
	int MarkVoiceReScore=0;
  	if(rs.next())
  	{
    	...
    	int IsVAAudioUpload = rs.getInt("IsVAAudioUpload");
     ...
     %>
       ...
       <tr>
        ...
        <tr>
            <td colspan="3">
                <iframe src="<%=recruitPath%>jsp/VAUploadUI.jsp" name="upload" width="100%" height="40" scrolling="no" frameborder="0" ></iframe>
            </td>
        </tr>
        <tr>
            <td colspan="3" align="center">   
            	 <input type="submit" name="submit" value="Update Score" class="buttonMedium" />
            </td>
        </tr>
    </table>
  		<%
