...
<%
	...
	System.out.println("USER_Name in Language Score ::::"+USER_Name);
	            ...
	            <table width="900px" border="0" cellpadding="0" cellspacing="0">
		            <tr>
						<td style="width:450px;">
							  <iframe src="<%=recruitPath%>jsp/LD_LangScoreLeft.jsp" name="left" width="450px" height="450px" scrolling="auto" frameborder="0" ></iframe>
						</td>
						<td style="width:450px;">
							  <iframe src="<%=recruitPath%>jsp/LD_LangScoreRight.jsp" name="right" width="450px" height="450px" scrolling="auto" frameborder="0" ></iframe>
						</td>
					</tr>
	            </table>
	        </td>
