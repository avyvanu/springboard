...
<%
			...
			{
				ImageMakerSIM.createImage(canId,EDKey,EDKPass);
	            ...
	            if(WebService_SubmitState==1)
	            {
		            ...
		            //String query="update bpo_candidatesreg_details set cand_Status=9,Program="+programid+",SubProgram="+subprogramid+" where Bpo_Cand_Id='" + canId + "'";
				    ...
				    String subject="[24]7 Career Details";
...
<script type="text/javascript" language="javascript">
   <% if(WebService_SubmitState==1) {%>
    alert("Candidate Offer Updated Successfully."); 
    <%} else {%>
     alert("Candidate Offer Failed. Please retry after some time."); 
     <%}%>
    parent.location.href= "<%=recruitPath%>jsp/SIM_Candidate_Offer.jsp";
</script>
  </head>
  <body>
  </body>
