...
System.out.println("User_Center_Id::::::Left sta update"+User_Center_Id);
String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details where cand_Status < 8  and Location='"+User_Center_Id+"'"; 
System.out.println("query:::STAupdateLeft:::::"+query);
...
function CheckValidation()
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/StaUpdateRight.jsp?candId="+canId;
  	}
