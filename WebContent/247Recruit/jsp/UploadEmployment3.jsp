...
String ProofStatus=(String)session.getAttribute("ProofStatus7");
System.out.println("UploadEmployement3 Page::::ProofStatus::::"+ProofStatus);
if(ProofStatus==null)
{
session.setAttribute( "ProofStatus7", "0");
ProofStatus = "0";
}
session.setAttribute( "proofName", "EmploymentProof3" );
...
String redURL=recruitPath + "jsp/UploadEmployment3.jsp?proofName="+proof;
session.setAttribute("redURL7",redURL);
...
System.out.println("Upload Employment3 page::::otherDetails::::"+otherDetails); 
session.setAttribute("OtherDetails7",otherDetails);
}
String FileName=(String)session.getAttribute("FileName7");
if(FileName==null)
{
FileName="";
}
System.out.println("Upload Employement3 page::::FileName::::"+FileName);
%>
...
<html>
  ...
  <body style="background-color: #F8F8F8;">
    <form name="FileUpoadForm" ENCTYPE="multipart/form-data" action="<%=recruitPath%>jsp/DocumentUpload.jsp?proofName=EmploymentProof3&proofType=7" method="post" onsubmit="return check(this);" >
    	<table cellpadding="0" cellspacing="0" border="0">
    		<tr>
    		<%
    		System.out.println("Upload Employment3 page::::Session Value of:::::"+ProofStatus);
    		if(ProofStatus.equalsIgnoreCase("1")){ 
    		%>
    		<script type="text/javascript" language="JavaScript">
    		var Employment3proofHiddenFld=parent.document.getElementById('Employment3proofHiddenFld');
        	Employment3proofHiddenFld.value = "1";
    		</script>
    		  <td>
    		...
    		<script type="text/javascript" language="JavaScript">
    		var Employment3proofHiddenFld=parent.document.getElementById('Employment3proofHiddenFld');
        	Employment3proofHiddenFld.value = "0";
    		</script>
            <td id="tdfile">
            	<input type="file" name="uploadfile" size="50" id="submit"/>
		     </td>
            <td align="center" style="width:75px;" id="tdbutton">
            	 <input type="submit" name="submit" value="Upload" class="inputFileButtons" onclick=" check();"/>
            </td>
