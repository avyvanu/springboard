	    ...
	    <tr>
	        ...
	        <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial;">
	            <a href="<%=recruitPath%>jsp/Admin_Home_Page.jsp">Administration > </a>
	             ...
	             <font class="nonLink">Manage CCA Resources</font>
	        </td>
	            ...
	            <table width="950px" border="0" cellpadding="0" cellspacing="0">
		            <tr>
						<td style="width:420px;">
							  <iframe src="<%=recruitPath%>jsp/Manage_CCA_ResourceLeft.jsp" name="left" width="420px" height="690" scrolling="auto" frameborder="0" ></iframe>
						</td>
						<td style="width:550px;">
							<iframe src="<%=recruitPath%>jsp/Manage_CCA_ResourceRight.jsp" name="right" width="550px" height="690" scrolling="no" frameborder="0" ></iframe>
						</td>
					</tr>
	            </table>
	        <br/>
