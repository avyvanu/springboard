...
session.setAttribute( "Bpo_Cand_Id", canId );
	...
	try
	{
		...
		rs=cs.executeQuery();
session.setAttribute( "page", "ChatScriptRight.jsp" );	
%>
...
<html>
  ...
  <body>
  <form name="BioForm" action="<%=recruitPath%>jsp/ChatScriptSubmit.jsp" method="post" onsubmit="return ValidatePage(this);">
        ...
        <tr>
            <td colspan="3" align="left" style="padding-left: 0px; padding-top: 0px; padding-bottom: 0px;">
		      <table border="0" cellpadding="0" cellspacing="0" width="100%">
		         <tr>
		            <td align="left" >
		               <textarea name="txtScript" id="txtScript" style="width: 350px; height: 75px;"  wrap="soft"></textarea>
		            </td>
		            <td align="center">
