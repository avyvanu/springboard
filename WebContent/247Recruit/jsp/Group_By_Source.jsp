     ...
     <table cellpadding="0" cellspacing="0" width="100%">
	    ...
	    <tr>
	        <td align="left" style="padding-left:10px;">
	            ...
	            <font class="nonLink">Group Wise Source Wise Report</font>
	        </td>
 	    ...
 	    <tr>
	        <td colspan="2" style="padding: 10px;">
				...
				<iframe src="<%=recruitPath%>jsp/Group_By_Source_Report.jsp" name="right" width="100%" height="525px" frameborder="0" ></iframe>	    
