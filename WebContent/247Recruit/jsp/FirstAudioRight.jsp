  ...
  <form name="BioForm">
	...
	int ApplyingFor=0;
  	if(rs.next())
  	{
    	...
    	int IsFirstRoundUpload = rs.getInt("IsFirstRoundUpload");
        ...
        <tr>
            <td colspan="3">
                <iframe src="<%=recruitPath%>jsp/VoiceUploadUI.jsp" name="upload" width="100%" height="40" scrolling="no" frameborder="0" ></iframe>
            </td>
        </tr>
