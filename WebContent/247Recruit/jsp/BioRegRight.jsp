...
<%
	...
	System.out.println("USER_Name in Bior right page ::::"+USER_Name);
   %>
<%
...
<html>
  <head>
    ...
    function ValidatePage(BioForm)
    {
    	...
    	if ( BioForm.chkBioCode.checked == true ) 
    	{ 
    		if ( BioForm.txtBioCode.value == "" ) 
    		{
    			alert ( "Please enter Bio Scan Code." ); 
    			BioForm.txtBioCode.focus();
    			return false; 
    		}
  ...
  <body>
  <form name="BioForm" action="<%=recruitPath%>jsp/BioRegSubmit.jsp" method="post" onsubmit="return ValidatePage(this);">
    <%
    String higeduc = null;
    int SkillSet=0;
	int Reveexp = 0;
	...
	int ApplyingFor=0;
  	if(rs.next())
  	{
       ...
       <tr>
        ...
        <tr>
            <td colspan="2" style="background-color: #d8d8d8;" class="allBackColor">
                <input type="checkbox" id="chkBioCode" name="chkBioCode" /> Biometric scan completed
            </td>
            <td>
                <input type="text" id="txtBioCode" name="txtBioCode" style="width:200px;" maxlength="30" onkeypress="return AllowAlphabet(event);" oncopy="return false" onpaste="return false" oncut="return false"/>
            </td>
        </tr>
