    ...
    <table cellpadding="0" cellspacing="0" width="100%">
	    ...
	    <tr>
	        ...
	        <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial;">
	            ...
	            <font class="nonLink">Repeat Candidate Search</font>
	        </td>
	             ...
	             <table width="950px" border="0" cellpadding="0" cellspacing="0">
		            <tr>
			            <td style="width:450px;">
				              <iframe src="<%=recruitPath%>jsp/RepSearchLeft.jsp" name="left" width="450px" height="250px" scrolling="auto" frameborder="0" ></iframe>
            				  
			            </td>
			            <td style="width:500px;">
				            <iframe src="<%=recruitPath%>jsp/RepSearchRight.jsp" name="right" width="500px" height="250px" scrolling="auto" frameborder="0" ></iframe>
			            </td>
		            </tr>
		            <tr>
		            	<td colspan="2" style="height:10px;"></td>
		            ...
		            <tr>
		            	<td colspan="2">
		            		<iframe src="<%=recruitPath%>jsp/RepSearchBottom.jsp" name="bottom" width="950px" height="300px" scrolling="auto" frameborder="0" ></iframe>
		            	</td>
		            </tr>
