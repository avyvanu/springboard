...
<%
	...
	System.out.println("User_Type_Id in LD Audio home page::::"+User_Type_Id);
   %>
  ...
  <body>
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
	    ...
	    <tr>
	        ...
	        <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial; "><a href="<%=recruitPath%>jsp/Home_Page.jsp">Home > </a><a href="<%=recruitPath%>jsp/Voice_Home.jsp">Voice > </a></font>
	            ...
	            <table width="950px" border="0" cellpadding="0" cellspacing="0">
		            <tr>
						<td style="width:450px;">
							  <iframe src="<%=recruitPath%>jsp/LD_VAAudioLeft.jsp" name="left" width="450px" height="500px" scrolling="auto" frameborder="0" ></iframe>
						</td>
						<td style="width:500px;">
							<iframe src="<%=recruitPath%>jsp/LD_VAAudioRight.jsp" name="right" width="500px" height="500px" scrolling="auto" frameborder="0" ></iframe>
						</td>
					</tr>
	            </table>
	        </td>
