...
String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details  where cand_status < 9 and Location='"+User_Center_Id+"'"; 
	...
	function CheckValidation()
	 ...
	 <script type="text/javascript" language="javascript">
	    function ChangeColor(tableRow, canId)
	    {
		    ...
		    parent.right.location.href= "<%=recruitPath%>jsp/Admin_Candidate_PwdRight.jsp?candId="+canId;
	  	}
	 </script>
  </head>
