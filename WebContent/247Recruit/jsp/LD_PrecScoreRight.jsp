...
<%
     ...
     System.out.println("USER_Name in LD audio righthome page::::"+USER_Name);
	...
	String precScorePath=recruitPath+"jsp/PrecisWritingScore.jsp?candidateid="+canId;
%>
  ...
  <head>
	...
	%>
	  function RedirectPage()
    	{
	 		parent.location.href= "<%=precScorePath%>";
	 	}
	 function showWindow()
	{
  ...
  <form name="BioForm" onsubmit="return RedirectPage();">
	...
	int MarkPrecReScore=0;
  	if(rs.next())
  	{
		...
		MarkPrecReScore = rs.getInt("MarkPrecReScore");
		System.out.println("MarkPrecReScore"+MarkPrecReScore);
		if(MarkPrecReScore==1)
		{
		session.setAttribute( "PrecisPageVal", "2" );
		}
		else
		{
		session.setAttribute( "PrecisPageVal", "1" );
		}
       ...
       <tr>
        ...
        <tr>
            <td colspan="3" align="center">   
                ...
                <input type="submit" name="submit" value="Score Précis" class="buttonMedium" />&nbsp;&nbsp;
