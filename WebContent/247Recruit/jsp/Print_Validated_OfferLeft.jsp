...
System.out.println("User_Center_Id::::::print validate page ops"+USER_ID);
Connection connection=ConnectDatabase.getConnection();	

String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details where Bpo_Cand_Id IN (select CandidateID from validate_candidate_offer_master) and Location='"+User_Center_Id+"'"; 
...
<html>
  <head>
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/Print_Validated_OfferRight.jsp?candId="+canId;
  	}
