...
<%	String USER_Name =(String)session.getAttribute("USER_Name");
	...
	String engGrammarTestId = request.getParameter("engGrammarTestId");	
	System.out.println("engGrammarTestId:::::View page"+engGrammarTestId);
%>
...
<body>
	<div class="wrapperSize" style="width: 720px;">
	 <div class="" style="clear: both;display: block; margin: 0 0 0;overflow: hidden;padding: 0;position: relative;">
		<form name="engGrammarTestPage" id="engGrammarTestPage" action="" method="post">
			<input type="hidden" name="methodName" id="methodName" value="storeRes"/>
				<div class="forms"  style="float: left;">
					<table border="0" cellpadding="6" width="100%" cellspacing="1" style="margin:15px 0 0 0" >
						<%
								String ranNum = engGrammarTestId;
								Connection con=null;
								...
								int engGrammarQsnId = 0;
								String engGrammarQsnPass=null;
								int qsnID=0;
								int no_qs=0;
								String qsnStr = null;
								String engGrammarHeader = null;
								try
								{
									String compQsnQry = "SELECT * FROM bpo_eng_comp_master where READING_COMP_MASTER_ID='"+ranNum+"'";
									...
									if(adrRs.next())
									{
									engGrammarQsnId = adrRs.getInt("READING_COMP_MASTER_ID");
									engGrammarQsnPass = adrRs.getString("PASSAGE");
									engGrammarHeader = adrRs.getString("Test_Header");
									}
								}
								catch (Exception e)
								{
						...
						<tr>
					       <td colspan="4"><div style="float:left;"> <p style="color: #aa0000;"><b><%=engGrammarHeader %> </b></p></div></td>
					    </tr>
						<tr>
							<td>
								...
								<input type="hidden" name="methodName" id="methodName" value="storeRes"/>
								<textarea class="quest_output" readonly="readonly" style="resize:none;"><%= engGrammarQsnPass %></textarea>
								</div>
								<div style="float: left;margin-left: 2px;width: 350px;" class="quest_output2">
								<%
									try{
											String sql3 ="SELECT No_of_Question FROM maximum_english_grammar";
								 ...
								 try
									{
										String compQsnQry12 = "SELECT * FROM bpo_eng_comp_question_master where READING_COMP_MASTER_ID='"+engGrammarQsnId+"' limit "+no_qs;
										...
										<%
										String compQsnQry123 = "SELECT * FROM bpo_eng_comp_question_answer_master  where READING_COMP_MASTER_ID="+engGrammarQsnId+" and READING_COMP_QUESTION_MASTER_ID="+qsnID ;
										...
										String qsnNopVal = USER_AUTOID+":"+engGrammarQsnId+":"+qsnID +":"+ adrRs124.getString("READING_COMP_QUESTION_ANSWER_MASTER_ID")+":"+adrRs124.getString("correct_answer");
							...
							<tr>
								<td colspan="1" align="right">  
									<input name="Submit"  style="cursor: none;" id="Submit" type="submit" value="Finish"  class="buttonSmall" disabled="disabled" onclick="return textvalidate();"/> 
