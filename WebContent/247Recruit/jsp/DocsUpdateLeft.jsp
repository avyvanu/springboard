...
<%
	...
	System.out.println("User_Center_Id::::::docs left page"+User_Center_Id);
	String query="select * from bpo_candidatesreg_details where cand_Status > 5 and cand_Status < 8 and Init_Result = 1 and Upload_Done = 0 and Location = '"+User_Center_Id+"'"; 
  ...
  <head>
	...
	<script type="text/javascript" language="javascript">
      function ChangeColor(tableRow, canId)
      {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/DocsUpdateRight.jsp?candId="+canId;
  	  }
    </script>
  </head>
