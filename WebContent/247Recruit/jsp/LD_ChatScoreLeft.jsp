...
<%@ page language="java" isELIgnored="false" import="java.sql.*,java.util.*,util.ConnectDatabase,java.text.SimpleDateFormat,java.util.Date" pageEncoding="utf-8"%>
...
function CheckValidation()
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/LD_ChatScoreRight.jsp?candId="+canId;
  	}
  </script>
  </head>
