...
<html>
  <head>
    ...
    <title>[24]7 Select Chat Test To Rescore</title>
	    ...
	    <tr>
	        <td align="left" style="padding-left:10px;">
	          <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial;">
	            ...
	            <a href="<%=recruitPath%>jsp/LD_SIM_Options.jsp">SIM > </a>
	            </font>
	            ...
	            <table width="900px" border="0" cellpadding="0" cellspacing="0">
		            <tr>
						<td style="width:450px;">
							  <iframe src="<%=recruitPath%>jsp/LD_ReChatScoreLeft.jsp" name="left" width="450px" height="450px" scrolling="auto" frameborder="0" ></iframe>
							  
						</td>
						<td style="width:450px;">
							<iframe src="<%=recruitPath%>jsp/LD_ReChatScoreRight.jsp" name="right" width="450px" height="450px" scrolling="auto" frameborder="0" ></iframe>
						</td>
					</tr>
	            </table>
	        </td>
