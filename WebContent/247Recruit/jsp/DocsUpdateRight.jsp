...
<%
	...
	System.out.println("USER_Name in docs right page page::::"+USER_Name);
  	...
  	if(rs.next())
  	{
        ...
        <tr>
            <td colspan="3" align="center">
                <input type="button" name="btnUploadCanDocs" class="buttonLarge" value="Upload Documents" onclick="javascript:parent.location.href='<%=recruitPath%>jsp/Cand_Doc_Upload.jsp'">
            </td>
        </tr>
    </table>
  		<%
