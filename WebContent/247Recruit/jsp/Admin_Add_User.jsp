    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
	    ...
	    <tr>
	        ...
	        <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial;">
	            ...
	            <font class="nonLink">Manage Users</font>
	        </td>
	            ...
	            <table width="950px" border="0" cellpadding="0" cellspacing="0">
		            <tr>
						<td style="width:420px;">
							  <iframe src="<%=recruitPath%>jsp/Admin_Add_UserLeft.jsp" name="left" width="420px" height="690" scrolling="auto" frameborder="0" ></iframe>
						</td>
						<td style="width:550px;">
							<iframe src="<%=recruitPath%>jsp/Admin_Add_UserRight.jsp" name="right" width="550px" height="690" scrolling="auto" frameborder="0" ></iframe>
						</td>
					</tr>
	            </table>
	        <br/>
