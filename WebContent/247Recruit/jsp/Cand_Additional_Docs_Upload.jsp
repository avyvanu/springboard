...
<%
    ...
    System.out.println("USER_Name in Candidate docs upload::::"+USER_Name);
   %>
   ...
   <table cellpadding="0" cellspacing="0" width="100%">
	    ...
	    <tr>
	        ...
	        <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial;">
	            ...
	            <font class="nonLink">Additional Documents Upload</font>
	        </td>
	            ...
	            <table width="950px" style="padding-top:10px;">
		            <tr>
			            <td style="width:450px;">
							<iframe src="<%=recruitPath%>jsp/AdditionalDocsUpdateLeft.jsp" name="left" width="450px" height="460px" scrolling="auto" frameborder="0" ></iframe>
						</td>
						<td style="width:500px;">
							<iframe src="<%=recruitPath%>jsp/AdditionalDocsUpdateRight.jsp" name="right" width="500px" height="460px" scrolling="auto" frameborder="0" ></iframe>
						</td>
		            </tr>
	            </table>
	        </td>
