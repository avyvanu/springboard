...
<%
	...
	System.out.println("USER_Name in additional docs right page page::::"+USER_Name);
...
<html>
  ...
  <body>
	...
	int ApplyingFor=0;
	int candAutoId = 0;
	String Bpo_Cand_Id = null;
  	if(rs.next())
  	{
		candAutoId = rs.getInt("AutoID");
		Bpo_Cand_Id = rs.getString("Bpo_Cand_Id");
  		session.setAttribute("Bpo_Cand_Id",Bpo_Cand_Id);
        ...
        <tr>
            <td colspan="3" align="center">
                <input type="button" name="btnUploadCanDocs" class="buttonLarge" value="Upload Documents" onclick="javascript:parent.location.href='<%=recruitPath%>jsp/Cand_Additional_Doc_Upload.jsp'">
            </td>
        </tr>
    </table>
  		<%
