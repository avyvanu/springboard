...
<%
	...
	try
	{
		 ...
		 System.out.println("USER_ID in Reports home page::::"+USER_ID);
	     USER_AUTOID = (Integer)session.getAttribute("USER_AUTOID");
	     if(USER_AUTOID == 0)
		  	{
		  	 response.sendRedirect(request.getContextPath() + "/247Recruit/jsp/Login.jsp");
		  	}
	     System.out.println("USER_AUTOID in Reports home page::::"+USER_AUTOID);
	     User_Type_Id = (String)session.getAttribute("User_Type_Id");
	     System.out.println("User_Type_Id in Reports home page::::"+User_Type_Id);
