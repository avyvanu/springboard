	    ...
	    <tr>
	        <td align="left" style="padding-left:10px;">
	         <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial;">
	            ...
	            <a href="<%=recruitPath%>jsp/SIM_Home.jsp">SIM > </a>
	            </font>
	            <font class="nonLink">Chat Upload</font>
	        </td>
	            ...
	            <table width="950px" border="0" cellpadding="0" cellspacing="0">
		            <tr>
						<td style="width:450px;">
							  <iframe src="<%=recruitPath%>jsp/LD_ChatScriptLeft.jsp" name="left" width="450px" height="475px" scrolling="auto" frameborder="0" ></iframe>
						</td>
						<td style="width:500px;">
							<iframe src="<%=recruitPath%>jsp/LD_ChatScriptRight.jsp" name="right" width="500px" height="475px" scrolling="auto" frameborder="0" ></iframe>
						</td>
					</tr>
	            </table>
	        </td>
