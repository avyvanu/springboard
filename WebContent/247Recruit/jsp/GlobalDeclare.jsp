...
<%
	...
	// ******  for the footer helping display option 
	String HelpDocVPath= basePath + "../247Recruitment/HelpDocs/HR_Help.pdf";  // for the recruiter 
	String HelpDocVPathLND= basePath + "../247Recruitment/HelpDocs/L&D_Help.pdf"; // for the L & D
	String HelpDocVPathOPS= basePath + "../247Recruitment/HelpDocs/OPS_Help.pdf"; // for the OPS
