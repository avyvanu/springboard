...
<table border="0" width="100%" style="padding-top: 5px;">
	<tr>
	        <td align="left" style="padding-left:10px;">
	            <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial; ">Reading Comprehension > </font>
	            <font style="color:#000000; font-weight:bold; font-size:12px; font-family:Arial; ">Success</font>	
	        </td>
	        <td align="right" style="font-size: 15px;font-family: Arial,Helvetica,sans-serif; color:white;">
...
<% 
	...
	System.out.println("userID for Reading Comprehension: ---------------  :"+USER_AUTOID);
	String message = request.getParameter("message");
	System.out.println("message for Reading Comprehension: ---------------  :"+message);
	Connection con=null;
	if(message!=null)
	{
		if(message.equalsIgnoreCase("compTestComplete"))
		{
			System.out.println("Inside Reading Comprehension !");
			...
			try
			{
			  ...
			  if(l>0)
			  {
			  	System.out.println("SucessFully Updated END_DATE_ACTIVE Reading Comprehension!");
			  }
			}
			catch (Exception e) 
			{
					...
					<tr>
						<td colspan="2" align="center" style="background:none repeat scroll 0 0 #F7F7F7;color: #666666;">
							<h3 style="display: block;font-size: 14px;font-family: Arial,Helvetica,sans-serif; margin: 0 0 10px;">
                     			You have completed the Reading Comprehension Test !
							</h3>
