	            ...
	            <table width="950px" border="0" cellpadding="0" cellspacing="0">
		            <tr>
						<td style="width:450px;">
							  <iframe src="<%=recruitPath%>jsp/ChatScriptLeft.jsp" name="left" width="450px" height="450px" scrolling="auto" frameborder="0" ></iframe>
							  
						</td>
						<td style="width:500px;">
							<iframe src="<%=recruitPath%>jsp/ChatScriptRight.jsp" name="right" width="500px" height="450px" scrolling="auto" frameborder="0" ></iframe>
						</td>
					</tr>
	            </table>
	        </td>
