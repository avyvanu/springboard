...
String USER_ID = (String)session.getAttribute("USER_ID");
	...
	System.out.println("User_Center_Id::::::chat script upload"+User_Center_Id);
String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details where MarkChatReScore=0 and cand_Status=4 and Applying_For=2 and IsChatTestUpload!=1 and Location='"+User_Center_Id+"'"; 
...
<html>
  <head>
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/ChatScriptRight.jsp?candId="+canId;
  	}
