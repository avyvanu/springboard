...
String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details where MarkVoiceReScore=1 and cand_Status=6 and Applying_For=1 and Location='"+LDCentreId+"'"; 
...
function CheckValidation()
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/LD_ReVoiceScoreRight.jsp?candId="+canId;
  	}
