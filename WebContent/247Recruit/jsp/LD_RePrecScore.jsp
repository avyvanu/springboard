...
<html>
  <head>
    <title>[24]7 Select Précis to Rescore</title>
	            ...
	            <table width="900px" border="0" cellpadding="0" cellspacing="0">
		            <tr>
						<td style="width:450px;">
							  <iframe src="<%=recruitPath%>jsp/LD_RePrecScoreLeft.jsp" name="left" width="450px" height="450px" scrolling="auto" frameborder="0" ></iframe>
							  
						</td>
						<td style="width:450px;">
							<iframe src="<%=recruitPath%>jsp/LD_RePrecScoreRight.jsp" name="right" width="450px" height="450px" scrolling="auto" frameborder="0" ></iframe>
						</td>
					</tr>
	            </table>
	        </td>
