...
//		  String EDKPass="247Cust0m3r";		
		 String candDocAutoId = request.getParameter("candDocAutoId");
		 System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>   candDocAutoId   >>>>> "+candDocAutoId);
		 ...
		 {	
			...
			cs = con.prepareCall("call Cand_AdditionalDoc_Disp_Proc(?,?,?)");
			cs.setString(1,candDocAutoId);
			cs.setString(2,EDKey);
			cs.setString(3,EDKPass);
			rs=cs.executeQuery();
			if (rs .next()) 
			{			   
			   Blob blb=rs.getBlob("Document_dataFile");
