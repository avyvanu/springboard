...
<head>
	...
	<script language="javascript" type="text/javascript" src="<%=request.getContextPath()%>/247Recruit/js/addRowComprehension.js"></script>	
	...
	function cancelAddView()
	{
		...
		{
			parent.window.location.href = '<%=request.getContextPath()%>/247Recruit/jsp/Admin_Manage_ComprehensionTest.jsp';
		}
	}
	</script>
...
<body>
     <table cellpadding="0" cellspacing="0" width="100%">
	    ...
	    <tr>
	        <td align="left" style="padding-left:10px;">
	           ...
	           <font style="color: #7E7E7E; font-weight: bold; font-size: 12px; font-family: Arial;">
					<a href="<%=recruitPath%>jsp/Admin_Manage_ComprehensionTest.jsp">Manage Reading Comprehension Tests > </a> 
			   </font>
	   ...
	   <tr>
	        ...
	        <!-- *************************************************************************** -->
	       <form action="<%=request.getContextPath()%>/AddComprehensionTest" name="addComprehensionTest" id="addComprehensionTest" method="post" autocomplete="off">
				<div id="EditDetailsData">	  
			        <table border="0" cellpadding="6" cellspacing="6" width="900">
			        	<tr>
			        		<th colspan="4" class="classCompTestleft_TD">Add New Reading Comprehension Test</th>
			        	</tr>
			        	<tr>
			        	...
			        	<tr>
			        		...
			        		<td colspan="3" class="classCompTestright_TD">
				        		<div id="TestHeaderDiv">
				        			<input type="text" name="TestHeader" id="TestHeader" class="inputText" value="Answer the questions given below after reading the passage :" maxlength="500" onkeypress="return AllowChars(event);"/>
								</div>
			        		</td>
			        	</tr>
			        	<tr>	
					    ...
					    <table border="0" cellpadding="6" width="100%" cellspacing="0" style="margin:15px 0 0 0" >
					       ...
					       <tr>
								...
								<div style="float: left;margin-left: 2px;width: 350px;" class="quest_output2">
									<div id="part1Qns1DISP">
									</div>
									<div id="part2Qns2DISP">
									</div>	
									<div id="part3Qns3DISP">
									</div>		
									<div id="part4Qns4DISP">
									</div>		
									<div id="part5Qns5DISP">
									</div>			
								</div>
								</td>
					       </tr>
