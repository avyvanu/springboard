...
String UsersTypeId = ((String)session.getAttribute("User_Type_Id")).trim(); 
  if(UsersTypeId == null)
	 {
		response.sendRedirect(request.getContextPath() + "/247Recruit/jsp/SessionTimeout.jsp");
	 }
System.out.println("UsersTypeId::::"+UsersTypeId);
...
{
	query="SELECT  * FROM  user_master where Emp_Id <> '"+USER_ID+"'  and User_Type_Id = '"+UsersTypeId+"' and Is_Deleted = 0"; 
}
System.out.println("query::::Admin Left Page for Users::"+query);
...
<html>
  <head>
    ...
    function ChangeColor(tableRow, EmpUserId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/Admin_Add_UserRight.jsp?EmpUserId="+EmpUserId;
  	}
