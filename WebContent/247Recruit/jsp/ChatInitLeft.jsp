...
System.out.println("prog value ::::"+progVal);
String USER_ID = (String)session.getAttribute("USER_ID");
if(USER_ID == null)
 	{
 	 response.sendRedirect(request.getContextPath() + "/247Recruit/jsp/Login.jsp");
 	}
System.out.println("USER_ID in Ops left  page::::"+USER_ID);
String User_Center_Id = (String)session.getAttribute("User_Center_Id");
if(User_Center_Id == null)
 	{
 	 response.sendRedirect(request.getContextPath() + "/247Recruit/jsp/Login.jsp");
 	}
System.out.println("User_Center_Id in Ops left page::::"+User_Center_Id);
Connection connection=ConnectDatabase.getConnection();		


String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details where cand_Status=6 and init_result=1 and Location='"+User_Center_Id+"' and Init_Selected_Program='"+progVal+"'"; 
  ...
  <head>
   <title>[24]7 SPRINGBOARD</title>
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/ChatInitRight.jsp?candId="+canId;
  	}
