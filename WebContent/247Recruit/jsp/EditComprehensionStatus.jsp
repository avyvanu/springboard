...
<html>
	...
	function call()
	{
		alert("Comprehension test status updated successfully.");
		top.window.location.href = '<%=request.getContextPath()%>/247Recruit/jsp/Admin_Manage_ComprehensionTest.jsp';
	}
	</script>
	<%
	}
	...
	function call()
	{
		alert("Can't deactivate all comprehension tests!! At least one must be active.");
		top.window.location.href = '<%=request.getContextPath()%>/247Recruit/jsp/Admin_Manage_ComprehensionTest.jsp';
	}
	</script>
	<%
	...
	function call()
	{
		alert("Comprehension test deleted successfully.");
		top.window.location.href = '<%=request.getContextPath()%>/247Recruit/jsp/Admin_Manage_ComprehensionTest.jsp';
	}
	</script>
	<%	
	...
	function call()
	{
		alert("Comprehension test inserted successfully.");
		top.window.location.href = '<%=request.getContextPath()%>/247Recruit/jsp/Admin_Manage_ComprehensionTest.jsp';
	}
	</script>
	<%	
