...
String query="select * from user_type_master";
...
<html>
  <head>
    ...
    function ChangeColor(tableRow, RoleID)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/Admin_Manage_RolesTask_MappingRight.jsp?RoleID="+RoleID;
  	}
 </script>
  <style type="text/css">
		html,body,form
 ...
 <body>
    <table width="100%" rules="all" style="border:1px solid black;background-color:#F2F2F2;margin:0;font-family: Arial,Helvetica,sans-serif; font-size: 13px;">
		<tr>
			...
			<td style="border-bottom:1px solid black;margin:0;" align="center"><b>Role Description</b></td>
			<td style="border-left:1px solid black;border-bottom:1px solid black;margin:0;" align="center" nowrap="nowrap" ><b>Status</b></td>
				...
				<%
					...
					while(rs.next())
					{%>
		<tr id="<%=i%>" onclick="javascript:ChangeColor(this,'<%=rs.getString("User_Type_Id")%>');">
			<td align="center">
				<%=i %>
			</td>
			<td>
