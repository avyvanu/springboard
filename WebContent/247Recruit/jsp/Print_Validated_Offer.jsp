...
<%
     ...
     System.out.println("USER_Name in print offer page::::"+USER_Name);
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
	    ...
	    <tr>
	        ...
	        <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial;">
	            ...
	            <font class="nonLink">Print Validated Offer</font>
	        </td>
	            ...
	            <table width="940px" border="0" cellpadding="0" cellspacing="0">
		            <tr>
						<td style="width:420px;">
							  <iframe src="<%=recruitPath%>jsp/Print_Validated_OfferLeft.jsp" name="left" width="420px" height="700" scrolling="auto" frameborder="0" ></iframe>
						</td>
						<td style="width:520px;">
							<iframe src="<%=recruitPath%>jsp/Print_Validated_OfferRight.jsp" name="right" width="520px" height="700" scrolling="auto" frameborder="0" ></iframe>
						</td>
					</tr>
	            </table>
	        </td>
