...
String ProofStatus=(String)session.getAttribute("ProofStatus3");
System.out.println("UploadBirth Page::::ProofStatus::::"+ProofStatus);
if(ProofStatus==null)
{
session.setAttribute( "ProofStatus3", "0");
ProofStatus = "0";
}
session.setAttribute( "proofName", "BirthProof" );
...
String redURL=recruitPath + "jsp/UploadBirth.jsp?proofName="+proof;
session.setAttribute("redURL3",redURL);
String otherDetails="";
...
System.out.println("Upload Birth page:: otherDetails"+otherDetails); 
session.setAttribute("OtherDetails3",otherDetails);
}
String FileName=(String)session.getAttribute("FileName3");
if(FileName==null)
{
FileName="";
}
System.out.println("Upload Birth page::::FileName::::"+FileName);
%>
...
<html>
  ...
  <body style="background-color: #F8F8F8;">
    <form name="FileUpoadForm" ENCTYPE="multipart/form-data" action="<%=recruitPath%>jsp/DocumentUpload.jsp?proofName=BirthProof&proofType=3" method="post" onsubmit="return check(this);" >
    	<table cellpadding="0" cellspacing="0" border="0">
    		<tr>
    		<%
    		System.out.println("Upload Birth page::::Session Value of:::::"+ProofStatus);
    		if(ProofStatus.equalsIgnoreCase("1")){ 
    		%>
    		<script type="text/javascript" language="JavaScript">
    		var BirthproofHiddenFld=parent.document.getElementById('BirthproofHiddenFld');
        	BirthproofHiddenFld.value = "1";
    		</script>
    		  <td>
