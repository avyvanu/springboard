    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
	    ...
	    <tr>
	        ...
	        <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial;">
	            ...
	            <font class="nonLink">Manage Roles</font>
	        </td>
	            ...
	            <table width="900px" border="0" cellpadding="0" cellspacing="0">
		            <tr>
						<td style="width:400px;">
							  <iframe src="<%=recruitPath%>jsp/Admin_Manage_RolesLeft.jsp" name="left" width="400px" height="700" scrolling="auto" frameborder="0" ></iframe>
						</td>
						<td style="width:450px;">
							<iframe src="<%=recruitPath%>jsp/Admin_Manage_RolesRight.jsp" name="right" width="450px" height="700" scrolling="auto" frameborder="0" ></iframe>
						</td>
					</tr>
	            </table>
	        <br/>
