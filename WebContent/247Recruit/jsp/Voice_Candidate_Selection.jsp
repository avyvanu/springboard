...
System.out.println("USER_Name in candidate selection voice::::"+USER_Name);
   %>
<html>
  <head>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
	    ...
	    <tr>
	        ...
	        <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial;">
	            ...
	            <font class="nonLink">Voice Candidate Selection</font>
	        </td>
	            ...
	            <table width="900px" border="0" cellpadding="0" cellspacing="0">
		            <tr>
						<td style="width:450px;">
							  <iframe src="<%=recruitPath%>jsp/Voice_Candidate_SelectionLeft.jsp" name="left" width="450px" height="450" scrolling="auto" frameborder="0" ></iframe>
						</td>
						<td style="width:450px;">
							<iframe src="<%=recruitPath%>jsp/Voice_Candidate_SelectionRight.jsp" name="right" width="450px" height="450" scrolling="no" frameborder="0" ></iframe>
						</td>
					</tr>
	            </table>
	        <br/>
