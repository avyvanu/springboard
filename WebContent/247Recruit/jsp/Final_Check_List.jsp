    ...
    <table cellpadding="0" cellspacing="0" width="100%">
	    ...
	    <tr>
	        ...
	        <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial;">
	            ...
	            <font class="nonLink">Documents Checklist</font>
	        </td>
	            ...
	            <table width="1000px" border="0" cellpadding="0" cellspacing="0">
		            <tr>
						<td style="width:450px;">
							  <iframe src="<%=recruitPath%>jsp/FinalCheckListLeft.jsp" name="left" width="450px" height="700" scrolling="auto" frameborder="0" ></iframe>
							  
						</td>
						<td style="width:550px;">
							<iframe src="<%=recruitPath%>jsp/FinalCheckListRight.jsp" name="right" width="550px" height="700" scrolling="auto" frameborder="0" ></iframe>
						</td>
					</tr>
	            </table>
	        </td>
