...
String ProofStatus=(String)session.getAttribute("ProofStatus8");
System.out.println("UploadSlip Page::::ProofStatus::::"+ProofStatus);
if(ProofStatus==null)
{
session.setAttribute( "ProofStatus8", "0");
ProofStatus = "0";
}
session.setAttribute( "proofName", "SlipProof" );
...
String redURL=recruitPath + "jsp/UploadSlip.jsp?proofName="+proof;
session.setAttribute("redURL8",redURL);
...
System.out.println("UploadSlip page:: otherDetails"+otherDetails); 
session.setAttribute("OtherDetails8",otherDetails);
}

String FileName=(String)session.getAttribute("FileName8");
if(FileName==null)
{
FileName="";
}
System.out.println("Upload Slip page::FileName::"+FileName);
%>
...
<html>
  ...
  <body style="background-color: #F8F8F8;">
    <form name="FileUpoadForm" ENCTYPE="multipart/form-data" action="<%=recruitPath%>jsp/DocumentUpload.jsp?proofName=SlipProof&proofType=8" method="post" onsubmit="return check(this);" >
    	<table cellpadding="0" cellspacing="0" border="0">
    		<tr>
    		<%
    		System.out.println("Upload Slip page::::Session Value of:::::"+ProofStatus);
    		if(ProofStatus.equalsIgnoreCase("1")){ 
    		%>
    		<script type="text/javascript" language="JavaScript">
    		var PaySlipproofHiddenFld=parent.document.getElementById('PaySlipproofHiddenFld');
        	PaySlipproofHiddenFld.value = "1";
    		</script>
    		  <td>
