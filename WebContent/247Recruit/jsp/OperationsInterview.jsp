...
<%
	...
	String USER_ID = (String)session.getAttribute("USER_ID");
	 ...
	 System.out.println("USER_ID in Admin home page::::"+USER_ID);
	String candID=(String)session.getAttribute("bioCanID");
	System.out.println("candID==="+candID);
	//String pagevalue=(String)session.getAttribute("page");
	//System.out.println("pagevalue==="+pagevalue);
	String progVal=(String)session.getAttribute("progVal");
	System.out.println("program Value+++==="+progVal);
    ...
    try
      {
	    ...
	    stApplyingFor.close();
	 	...
	 	//**************End of Applying For*****************//	
	    String secQsncandidate = "SELECT Candidate_ID FROM operations_interview_master where Candidate_ID='"+ cid + "' and End_date is null" ;
	    ...
	    if(state==false)
	    {
			...
			proc = con.prepareCall("{ call operations_interview_Proc(?,?)}");
...
function CheckValidation()	 
		 {
			...
			if (( operationsubmitform.select[0].checked == false ) && ( operationsubmitform.select[1].checked == false )&&( operationsubmitform.select[2].checked == false ) ) 
			{ 
  	 ...
  	 <table cellpadding="0" cellspacing="0" width="100%">
	    ...
	    <tr>
	        <td align="left" style="padding-left:15px;">
	           <font style="color:#7E7E7E; font-weight:bold; font-size:12px; font-family:Arial; "><a href="<%=recruitPath%>jsp/Home_Page.jsp">Home</a> > <a href="<%=recruitPath%>jsp/Chat_Init.jsp?progVal=<%=progVal%>">Operations Interview</a> > </font>
	            <font style="color:#000000; font-weight:bold; font-size:12px; font-family:Arial; ">Interview</font>
	        </td>
...
<table width="920px" cellspacing="6" cellpadding="6" border="0">
             ...
             <%
			   ...
			   <td width="120px" rowspan="3" style="padding: 0px;"> 
			    ...
			    <td width="350px" class="allBackColor" id="candidateid" align="left"><%=candID%>
		          ...
		          <input type="hidden" name="recruitername" value="<%= USER_Name%>">
              ...
              <%  
                ...
                String secqrypartid = "select Part_Description,Part_Id,order_no from operations_interview_part_master where Program_Id='"+progVal+"' and isalive=1 order by order_no";
  ...
  <tr align="center">
    ...
    <td style="background-color: #F2F2F2;"> <textarea name="P<%=Porderno%>Q<%=qorderno%>Comment"  id="P<%=Porderno%>Q<%=qorderno%>Comment"  rows="2" style="width: 100%;resize:none" oncopy="return false" onpaste="return false" oncut="return false" onkeypress="return AllowChars(event);"></textarea></td>
    <td class="allBackColor">
    <select name="P<%=Porderno%>Q<%=qorderno%>Score" size="1" id="P<%=Porderno%>Q<%=qorderno%>Score" onchange="calcscore()" style="width: 100%; height: 20px; color: #342826;text-align: center" >
     <option value="">Select</option>
          ...
          <tr>
           <td class="allBackheading" align="center" colspan="4">Mention all verbatim - in the interview form
			   ...
			   <input type="hidden" name="prgmvalues" id="prgmvalues" value="<%=progVal %>"/></td>
	      </tr>
