...
<%
    ...
    System.out.println("USER_Name in stability page::::"+USER_Name);
	...
	session.setAttribute( "page", "Voice_Home.jsp" );	
	String voiceScorePath= recruitPath + "jsp/StabilityCheckScore.jsp?candId=" + canId;
%>
  ...
  <form name="BioForm" onsubmit="return RedirectPage();">
	...
	int ApplyingFor=0;
  	if(rs.next())
  	{
    	...
    	//**************Current Skill Set For Experience*****************//
			...
			System.out.println("querySkillSet:::::::"+querySkillSet);
    ...
    %>
       ...
       <tr>
            ...
            <td align="left" style=" width:200px; padding-left:3px;" class="allBackColor">
                <%=Phone%>
            </td>
        </tr>
        <tr>
