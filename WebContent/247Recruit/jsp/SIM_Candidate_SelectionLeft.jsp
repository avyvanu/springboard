...
<%
	...
	System.out.println("User_Center_Id::::::sim selection"+User_Center_Id);
	String query="select Bpo_Cand_Id,First_Name,Middle_Name,Last_Sir_Name from bpo_candidatesreg_details where cand_Status=6 and Applying_For=2 and init_result in (0,2) and Location='"+User_Center_Id+"'"; 
	System.out.println("Query For Display LeftSide List \t"+query);
	...
	if((FromDAte!=null ) && (ToDAte!=null))
	{
		...
		System.out.println("Query For Display Left Side List \t"+query);
		}
...
<html>
  <head>
    ...
    function ChangeColor(tableRow, canId)
    {
	    ...
	    parent.right.location.href= "<%=recruitPath%>jsp/SIM_Candidate_SelectionRight.jsp?candId="+canId;
  	}
