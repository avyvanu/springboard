...
function addRowHeaderOnloadStability()
{
	var tbl = document.getElementById(TABLE_NAME);
	
/*<<<<<<<<<<<<<<<<<<<<<<<<< Create Inner Table & hidden input for tbl >>>>>>>>>>>>>>>>>>>>>>>>> 	*/
	var tot_parts = document.getElementById('total_parts_st').value;
	...
	/*<<<<<<<<<<<<<<<<<<<<<<<<< Add Row buttons OnLoad >>>>>>>>>>>>>>>>>>>>>>>>> 	*/
		...
		txtInp3.setAttribute('onclick', 'addRowQuestionStability('+i+');' );	
...
function onPreviewStability()
{
	...
	for( var a =1;a<= tot_parts;a++)
	{
		...
		divinner.setAttribute('style','width: 900px;');
		...
		divb.setAttribute('style','width: 120px;');
		...
		divd.setAttribute('style','width: 200px;');
		...
		dive.setAttribute('style','width: 180px;');
		...
		{ 
			...
			cmt.setAttribute('style','width:200px; resize:none;');
			...
			divi.setAttribute('class', 'allBackColor');
			scr.setAttribute('style','width:180px; height: 20px; color: #342826;text-align: center;');
...
function addRowHeaderStability()
{
	var tbl = document.getElementById(TABLE_NAME);
...
/*<<<<<<<<<<<<<<<<<<<<<<<<< Enter the Question 1 OnLoad >>>>>>>>>>>>>>>>>>>>>>>>> */	
	// add the row
function addQuestionOnloadStability()
{
	var j = 0;
	var tblnew = document.getElementById("part"+part+"Tbl");
...
/*<<<<<<<<<<<<<<<<<<<<<<<<< Add Row buttons OnLoad >>>>>>>>>>>>>>>>>>>>>>>>> 	*/
function addRowButtonsOnloadStability()
{
	var tblnew = document.getElementById("part"+part+"Tbl");
	...
	txtInp3.setAttribute('class', 'buttonMedium' );	
	txtInp3.setAttribute('style', ' float:right;');
	txtInp3.setAttribute('onclick', 'addRowQuestionStability('+part+');' );	
	celly.setAttribute('colspan', '3');
	celly.appendChild(txtInp3);
...
function addQuestionOnAddPartStability()
{
	...
	txtInp.setAttribute('class', 'reSizeforOther' );	
	txtInp.setAttribute('maxlength', '500' );	
	txtInp.setAttribute('onblur', 'return removeSplChar('+part+','+iter1+');' );
	cell1.className = 'classOprnright_JS';	
	cell1.setAttribute('colspan', '3');
	cell1.appendChild(txtInp);
...
function addRowButtonsOnAddPartStability()
{
	var tblnew = document.getElementById("part"+part+"Tbl");
...
function addRowQuestionStability(partId)
{
...
/*<<<<<<<<<<<<<<<<<<<<<<<<< Enter the Question from 2 part >>>>>>>>>>>>>>>>>>>>>>>>> */	
	...
	txtInp.setAttribute('class', 'reSizeforOther' );	
	txtInp.setAttribute('maxlength', '500' );	
	txtInp.setAttribute('onblur', 'return removeSplChar('+partId+','+iteration+');' );
	cell1.className='classOprnright_JS';	
	cell1.setAttribute('colspan', '3');
	cell1.appendChild(txtInp);
...
function deleteCurrentRow(obj,partId,qnsId)
{
	...
	if (nextRow >3)
	{
		if(confirm('Are you sure you want to delete Question '+qnsId+' of Part '+partId+'? You will not be able to undo this change.' ))
		{
	...
	{
		alert('Cannot delete. At least one row required !');	
	}
...
function deleteCurrentPart(partId)
{
	...
	if(nextRow > 1)		
	{
		if(confirm('Are you sure you want to delete the entire Part '+partId+'? You will not be able to undo this change.' ))
		{
	...
	{
		alert('Cannot delete. At least one part required !');	
	}
}
...
function reorderPart(startingIndex)
{
	...
	{				
		...
		document.getElementById('addQuesPart'+ NewId +'button' ).setAttribute('onclick', 'addRowQuestionStability('+ NewId +');' );	
