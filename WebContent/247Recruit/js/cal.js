...
(function($) { // create private scope (inside you can use $ instead of jQuery)
    ...
    $.fn.simpleDatepicker = function(options) {
		...
		function newDatepickerHTML () {
			...
			jQuery("tfoot",table).append('<tr><td colspan="2"><span class="today">today</span></td><td colspan="3"><span class="clear">clear</span></td><td colspan="2"><span class="close">close</span></td></tr>');
		...
		function clearIt(el, datepicker, dateObj) { 
			var chosenDate="";
			el.val(chosenDate);
			datepicker.remove();
			datepicker = null;
			...
			if ( jQuery(this).is('input') && 'text' == jQuery(this).attr('type')) {
				...
				jQuery(this).click(function (ev) {
					...
					if (false == jQuery.data($this.get(0), "simpleDatepicker").hasDatepicker) {
						...
						jQuery("span.clear", datepicker).click(function () { clearIt($this, datepicker); });
