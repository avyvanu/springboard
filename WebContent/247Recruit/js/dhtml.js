...
function addRowToTable(num)
{
	if (hasLoaded) {
		...
		txtInp0.setAttribute('name', 'lang');
		txtInp0.setAttribute('id', 'lang');
		...
		txtInp1.setAttribute('name', 'lang');
		txtInp1.setAttribute('id', 'lang');
		...
		txtInp2.setAttribute('name', 'lang' );
		txtInp2.setAttribute('id', 'lang' );
		...
		cbEl.setAttribute('name', 'lang');
		cbEl.setAttribute('id', 'lang');
		...
		btnEl.setAttribute('src', '/IPC_Online_Chat/images/btn-delete.gif');
