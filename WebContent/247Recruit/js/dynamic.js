...
function addRowToTable(num)
{
	if (hasLoaded)
	{
		...
		newlabel.innerHTML = "Enter Question "+(iteration+1);		
		cella.className='classlangTestleft_TDDYNA';	
		...
		document.getElementById('PartAPart1QCountDIV').innerHTML = (iteration+1);
