...
function addRowToTable(num)
{
	if (hasLoaded) {
		...
		txtInp0.setAttribute('name', 'lang_o'+ iteration);
		txtInp0.setAttribute('id', 'lang_o'+ iteration);
		...
		txtInp1.setAttribute('name', 'lang_r'+ iteration);
		txtInp1.setAttribute('id', 'lang_r'+ iteration);
		...
		txtInp2.setAttribute('name', 'lang_w'+ iteration );
		txtInp2.setAttribute('id', 'lang_w'+ iteration );
		...
		cbEl.setAttribute('name', 'lang_s'+ iteration);
		cbEl.setAttribute('id', 'lang_s'+ iteration);
