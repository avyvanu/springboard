...
function buildWeeklyCalendar(WeekStart)
{
    ...
    document.write('<tr class="firstrow"><td width="8px" onClick="w_renderCalendar(-1);" align="right" ><img src="../CalNew/arrow_left.gif" title="' + prev_month_title + '" border="0"></td>');
    document.write('<td width="8px" onClick="w_renderCalendar(1);" align="left" ><img src="../CalNew/arrow_right.gif" title="' + next_month_title + '" border="0"></td>');
    ...
    document.write('<td align="center" onClick="w_hiddenCalendar()"><img src="../CalNew/close.jpg" title="' + close_title + '" border="0"></td>');
