...
function redirect()
{
	window.location.href="ControllerServlet?target=ComprehensionTest";
	return false;
}
function logout()
{
...
<table border="0" width="100%" style="padding-top: 5px;">
     <tr>   
	    <td align="left" style="padding-left:10px;">
	        ...
	        <font style="color:#000000; font-weight:bold; font-size:12px; font-family:Arial; ">Comprehension</font>		
		</td>
...
<div class="inner-content">
  <div class="cont-lft-twocol">
	...
	<h3>Reading Comprehension Test</h3>
     ...
     <li>The reading passage would be displayed on the left hand side. Read the passage carefully and quickly.</li>
     <li>A set of questions with multiple choice answers would be displayed to the right hand side of the passage. </li>
     ...
     <img src="../images/read_compp.jpg" alt="" align="center" style="padding-left:75px;" />
