...
//							}else{
//									pst.setDouble(8,java.sql.Types.DOUBLE);
//							}
...
//									.prepareStatement(""
//											+ "insert into cand_friend_bpo_job_details(Cand_Passed_Auto_Id, Cand_BPO_JOB_name, Cand_BPO_JOB_phone_No, Cand_BPO_JOB_Email_Id, Cand_BPO_JOB_BPO_exp)"
//											+ "values(?,?,?,?,?)");
//							pst.setInt(1, USER_AUTOID);
...
//							
//							if(!RelarionShip[i].equals("")){ 
//								pst.setInt(3, Integer.parseInt((RelarionShip[i])));
//							}else{
//								pst.setInt(3,java.sql.Types.INTEGER);
//							}							
//							//pst.setInt(3, Integer.parseInt(RelarionShip[i]));
//							
...
//							}
//							
//							if(!FBAgeget[i].equals("")){ 
//								pst.setInt(5, Integer.parseInt((FBAgeget[i])));
//							}else{
//								pst.setInt(5,java.sql.Types.INTEGER);
//							}
//							//pst.setInt(5, Integer.parseInt(FBAgeget[i]));
//							
...
//						
//						if(!SSCQualification.equals("")){ 
//							pst.setInt(4, Integer.parseInt((SSCQualification)));
//						}else{
//							pst.setInt(4,java.sql.Types.INTEGER);
//						}
//						//pst.setInt(4, SSCQualification);
//						
//						
//						if(!EQyearOfJoinSSC.equals("")){ 
...
//						
//						if(!ScoreEQSSC.equals("")){ 
//							pst.setDouble(12, Double.parseDouble(ScoreEQSSC));
//						}else{
//							pst.setDouble(12,java.sql.Types.DOUBLE);
//						}
//						//pst.setDouble(12, Double.parseDouble(ScoreEQSSC));
//						
...
//					
//					if(!SpecializationHSC.equals("")){ 
//						pst.setInt(14, Integer.parseInt(SpecializationHSC));
//					}else{
//						pst.setInt(14,java.sql.Types.INTEGER);
//					}
...
//							
//							if(!EQmediumOfEduHiger[i].equals("")){ 
...
//							//pst.setInt(3, Integer.parseInt(EQmediumOfEduHiger[i]));
//							
//							if(!QualificationEQHigher[i].equals("")){ 
...
//							//pst.setInt(6, Integer.parseInt(monthNameHiger[i]));
//							
//							if(!EQyearOfJoinMHiger[i].equals("")){ 
...
//							
//							
//							if(!SpecializationHiger1[i].equals("")){ 
...
//							//pst.setInt(14, Integer.parseInt(SpecializationHiger1[i]));
//							
//							if(!SpecializationHiger2[i].equals("")){ 
//								pst.setInt(15, Integer.parseInt(SpecializationHiger2[i]));
//							}else{
//								pst.setInt(15,java.sql.Types.INTEGER);
//							}
//							//pst.setInt(15, Integer.parseInt(SpecializationHiger2[i]));
//							
//							if(!EQCourse_CategoryHiger[i].equals("")){ 
//								pst.setInt(16, Integer.parseInt(EQCourse_CategoryHiger[i]));
//							}else{
//								pst.setInt(16,java.sql.Types.INTEGER);
//							}
//							//pst.setInt(16, Integer.parseInt(EQCourse_CategoryHiger[i]));
//							
//							if(!CourseType[i].equals("")){ 
//								pst.setInt(17, Integer.parseInt(CourseType[i]));
//							}else{
//								pst.setInt(17,java.sql.Types.INTEGER);
//							}
//							//pst.setInt(17, Integer.parseInt(CourseType[i]));
//							
//							if(!EQDCYear[i].equals("")){ 
//								pst.setInt(18, Integer.parseInt(EQDCYear[i]));
//							}else{
//								pst.setInt(18,java.sql.Types.INTEGER);
//							}
//							//pst.setInt(18, Integer.parseInt(EQDCYear[i]));
//							
//							if(!EQDCMonth[i].equals("")){ 
//								pst.setInt(19, Integer.parseInt(EQDCMonth[i]));
//							}else{
//								pst.setInt(19,java.sql.Types.INTEGER);
//							}
//							//pst.setInt(19, Integer.parseInt(EQDCMonth[i]));
//							
//							
...
//					PreparedStatement pst = con
//							.prepareStatement(""
//									+ "insert into cand_declare_details(Cand_Dec_CandID, Cand_Dec_1, Cand_Dec_2, Cand_Dec_3, Cand_Dec_4)"
//									+ "values(?,?,?,?,?)");
//					pst.setInt(1, USER_AUTOID);
